...
from .auth import SignupApi, LoginApi,LoginApiUser
from .admin_auth import SignupAdminApi,LoginAdminApi,LogoutApiAdmin
...
def initialize_routes(api):
    ...
    api.add_resource(LogoutApiUser,'/api/logoutuser')
    ...
    api.add_resource(LoginAdminApi, '/api/logoutadmin')
